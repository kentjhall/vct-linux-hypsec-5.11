...
noinline volatile uint64_t __hyp_text load_3(const unsigned char *in) {
    uint64_t result;
...
noinline volatile uint64_t __hyp_text load_4(const unsigned char *in) {
	uint64_t result = 0;
...
void __hyp_text sc_reduce(unsigned char *s) {
...
void __hyp_text sc_muladd(unsigned char *s, const unsigned char *a, const unsigned char *b, const unsigned char *c) {
