...
void init_hacl_hash(struct el2_data *el2_data)
{
	...
	el2_memcpy(el2_data->hacl_hash0, Hacl_Hash_Core_SHA2_Constants_k224_256, sizeof(uint32_t)*64);
	el2_memcpy(el2_data->hacl_hash, Hacl_Hash_Core_SHA2_Constants_k384_512, sizeof(uint64_t)*80);
...
uint32_t get_hacl_hash_sha2_constant_k224_256(int i)
{
	...
	el2_data = kern_hyp_va((void *)(void *)&(el2_data_start));
