...
void remap_vm_image(u32 vmid, u64 pfn, u32 load_idx)
{
	...
	if (state == READY)
	{
		...
		if (load_idx < load_info_cnt)
		{
			...
			{
				/* kvm_pte_t attr = PAGE_S2_MEMATTR(NORMAL) | KVM_PTE_LEAF_ATTR_HI_S2_XN | KVM_PTE_LEAF_ATTR_LO_S2_S2AP_R | KVM_PTE_LEAF_ATTR_LO_S2_S2AP_W | FIELD_PREP(KVM_PTE_LEAF_ATTR_LO_S2_SH, KVM_PTE_LEAF_ATTR_LO_S2_SH_IS) | KVM_PTE_LEAF_ATTR_LO_S2_AF; */
				/* u64 pa = __pfn_to_phys(pfn); */
				/* kvm_pte_t pte = pa & KVM_PTE_ADDR_MASK; */
				/* if (PAGE_SHIFT == 16) */
				/* 	pte |= FIELD_PREP(KVM_PTE_ADDR_51_48, pa >> 48); */
				/* pte |= attr & (KVM_PTE_LEAF_ATTR_LO | KVM_PTE_LEAF_ATTR_HI); */
				/* pte |= FIELD_PREP(KVM_PTE_TYPE, KVM_PTE_TYPE_PAGE); */
				/* pte |= KVM_PTE_VALID; */
